...
- <img src="https://cdn.simpleicons.org/clickup/FF6B6B" height="14"/> [click-to-mcp](https://github.com/Coding-Dev-Tools/click-to-mcp) - Auto-wrap any Click/typer CLI as an MCP server (Model Context Protocol). Run `npx click-to-mcp` to generate MCP servers from any CLI tool.
